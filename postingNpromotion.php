...
<div class="main_text_box">
        ...
        <div>
            <form method="post" style="width: 90%;" action="" onsubmit="return beforeSubmit()">
                     ...
                     <fieldset style="border:3px solid #686c70;width: 99%;">
                       ...
                       echo  '</tr>
                            <tr>
                                ...
                                <td colspan="3" style="width: 40%"><input type="text" class="box" readonly value="'.$db_postname.'" /><input type="hidden" name="newpostID" id="newpostID" value="'.$p_postingID.'" /></td>
                             </tr>
                            <tr>
                                <td style="width: 30%; text-align:right">পোস্টিং তারিখ</td>
                                <td colspan="3" style="width: 40%"><input type="date" class="box" name="postingDate" id="postingDate" /><em2>*</em2></td>
                             </tr>
                            </table>
                            </filedset></td>
                    </tr>';
                ...
                echo "<tr>                    
                                    <td colspan='4' style='text-align: center' ><input class='btn' style ='font-size: 12px; width:200px' type='submit' name='postingNpromotion' value='পোস্টিং এন্ড প্রোমোশন' /></td>                           
                            </tr>";
                echo "</table>";
                ?>
            </form>
