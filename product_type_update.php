...
$sql_up_type = $conn->prepare("UPDATE product_catagory SET pro_type = ? WHERE  pro_type = ?");
$msg ="";
if(isset($_POST['update']))
{
    $p_current = $_POST['current_name'];
    $p_update = $_POST['up_name'];
    $upquery = $sql_up_type->execute(array($p_update,$p_current));
    if ($upquery ==1)
	{$msg = "আপডেট হয়েছে"; }
        else { $msg ="আপডেট হয়নি"; }
}
...
<body>
                ...
                <table  class="formstyle" style="font-family: SolaimanLipi !important;margin: 0 !important;">          
                  ...
                  <tr>
                    ...
                    <td>: <input  class="box" type="text" name="current_name"  id="current_name" value="<?php echo $g_typename;?>" readonly /></td>   
                    </tr>
                    <tr>
