...
$g_typecode = $_GET['typeCode'];
$g_typename = $_GET['typeName'];

$sql_up_category = $conn->prepare("UPDATE product_catagory SET pro_type_code = ? WHERE  pro_type_code = ?");
...
<body>
                ...
                <table  class="formstyle" style="font-family: SolaimanLipi !important;margin: 0 !important;">          
                    ...
                    <td>: <input  class="box" type="text" name="catagori"  id="catagori" value="<?php echo $g_typename;?>" readonly /></td>   
                    </tr>
                  <tr>
                    <td style="text-align: center; width: 50%;">বর্তমান কোড</td>
                    <td>: <input  class="box" type="text" name="current_code"  id="current_code" value="<?php echo $g_typecode;?>" readonly /></td>   
                    </tr>
                    <tr>
