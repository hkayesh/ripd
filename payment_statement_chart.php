...
$sel_send_amount = $conn->prepare("SELECT * FROM acc_user_amount_transfer WHERE trans_type = 'send'
                                                AND trans_senderid = ? ORDER BY trans_date_time");
$sel_selected_send_amount = $conn->prepare("SELECT * FROM acc_user_amount_transfer WHERE trans_type = 'send'
                                                AND trans_senderid = ? AND trans_date_time BETWEEN ? AND ? ORDER BY trans_date_time");
?>
...
<div class="main_text_box">
    ...
    <div>
        <table class="formstyle"  style="font-family: SolaimanLipi !important;width: 80%;">          
            <tr><th style="text-align: center" colspan="2"><h1>টাকা পাঠানোর স্টেটমেন্ট</h1></th></tr>
                <tr>
                    <td id="noprint">
            ...
            <tr>
                <td>
                    <fieldset style="border: 3px solid #686c70 ; width: 99%;font-family: SolaimanLipi !important;">
                            <legend style="color: brown;font-size: 14px;">পাঠানো টাকার স্টেটমেন্ট</legend>
                    <table style="margin: 0 auto;" cellspacing="0" cellpadding="0">
                        <thead>
                            <tr id="table_row_odd">
                                <td width="9%" style="border: solid black 1px;"><div align="center"><strong>ক্রম</strong></div></td>
                                <td width="15%"  style="border: solid black 1px;"><div align="center"><strong>তারিখ</strong></div></td>
                                <td width="20%"  style="border: solid black 1px;"><div align="center"><strong>প্রাপকের মোবাইল নং</strong></div></td>
                                ...
                                <td width="15%" style="border: solid black 1px;"><div align="center"><strong>সেন্ড এমাউন্ট (টাকা)</strong></div></td>
                                <td width="15%" style="border: solid black 1px;"><div align="center"><strong>অবস্থা</strong></div></td>
                            </tr>
                        </thead>
                                    ...
                                    if(isset($_POST['submit']))
                                        {
                                            ...
                                            $sel_selected_send_amount->execute(array($userID,$p_startdate,$p_lastDate));
                                                ...
                                                echo "<td  style='border: solid black 1px;'>".english2bangla($db_recver_mbl)."</td>";
                                                ...
                                                echo '<td  style="border: solid black 1px;"><div align="center">'.$arr_trans[$db_status].'</div></td>';                                              
                                                echo '</tr>';
                                                $slNo++;
                                            }
                                        }
