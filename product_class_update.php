...
$g_classname = $_GET['className'];
$g_calsscode = $_GET['classCode'];
$sql_up_category = $conn->prepare("UPDATE product_chart SET pro_classification = ? WHERE  pro_classification_code = ?");
$msg ="";
...
<body>
                ...
                <table  class="formstyle" style="font-family: SolaimanLipi !important;margin: 0 !important;">          
                  ...
                  <tr>
                    ...
                    <td>: <input  class="box" type="text" value="<?php echo $g_classname;?>" readonly />
                    <input type="hidden" name="current_code"  id="current_code" value="<?php echo $g_calsscode;?>" /></td>   
                    </tr>
                    <tr>
