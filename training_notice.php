...
<script type="text/javascript">
    function infoPresentationFromThana()
    {
        ...
        xmlhttp.open("GET","includes/infoProgramFromThana.php?dsd="+district_id+"&dvd="+division_id+"&ttid="+thana_id+"&df="+date_from+"&dt="+date_to+"&type=training",true);
        xmlhttp.send();
    }
</script>
<div class="page_header_div"><div class="page_header_title">ট্রেইনিং সিডিউল</div></div>
            ...
            <table id="office_info_filter" border="1" align="center" width= 99%" cellpadding="5px" cellspacing="0px">
                <thead>
                    <tr align="left" id="table_row_odd">
                        <th><?php echo "ট্রেইনিং-এর নাম"; ?></th>                  
                        <th><?php echo "লোকেশন"; ?></th>
                        <th><?php echo "বিষয়" ?></th>
                        <th><?php echo "তারিখ"; ?></th>
                        <th><?php echo "সময়"; ?></th>
                        <th><?php echo "ট্রেইনার"; ?></th>       
                ...
                <tbody>
                    <?php
                $sql_programTable = "SELECT * FROM program,office WHERE program_type = 'training'
