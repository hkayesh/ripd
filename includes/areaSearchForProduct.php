<?php
error_reporting(0);
function getAreaOffice() 
    {
    ?>            
    <select name="division_id" id="division_id" class="box2" onChange="getDistrict(); getThana()" >
    ...
    <span id="tid">
        <select name='thana_id' id='thana_id' class="box2" onChange="getOffice(this.value)">
