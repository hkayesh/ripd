...
{                                 
 ...
 elseif($holiday==1)
     {
    echo "<tr><td colspan='13' style='text-align:center;color:red;font-size:16px;'>দুঃখিত, আজ ছুটির দিন</br> অফডে কর্মচারীর হাজিরার জন্য নিম্নের লিঙ্ক-এ ক্লিক করুন</td></tr>";
    echo "<tr><td colspan='13' style='text-align:center;font-size:18px;'><a href='offday_emp_attendance.php'>অফডে কর্মচারীর হাজিরা</a></td></tr>";
}
