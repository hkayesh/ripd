...
<script type="text/javascript">
    function infoProgramFromThana()
    {
        ...
        xmlhttp.open("GET","includes/infoProgramFromThana.php?dsd="+district_id+"&dvd="+division_id+"&ttid="+thana_id+"&df="+date_from+"&dt="+date_to+"&type=program",true);
        xmlhttp.send();
    }
</script>
<div class="page_header_div"> <div class="page_header_title">প্রোগ্রাম সিডিউল</div></div>
...
<div style="float: left; width: 100%; padding-bottom: 10px;padding-top: 10px; margin-left: 0px;">
    ...
    <input type="hidden" id="method" value="infoProgramFromThana()">
    <input type="button" onclick="infoProgramFromThana()" value="সাবমিট">
</div>
<span id="office" >
    <div class="presen_pro_training_travel_table">
        <table id="office_info_filter" border="1" align="center" width= 99%" cellpadding="5px" cellspacing="0px">
            ...
            <tbody>
                <?php
                $sql_programTable = "SELECT * FROM program,office WHERE program_type = 'program'
