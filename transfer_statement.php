...
$sel_send_amount = $conn->prepare("SELECT * FROM acc_user_amount_transfer  JOIN cfs_user ON trans_receiverid = idUser 
                                                                WHERE trans_type = 'transfer' AND trans_senderid = ? ORDER BY trans_date_time");
$sel_selected_send_amount = $conn->prepare("SELECT * FROM acc_user_amount_transfer JOIN cfs_user ON trans_receiverid = idUser
                    ...
                    <table style="margin: 0 auto;" cellspacing="0" cellpadding="0">
                        <thead>
                            <tr id="table_row_odd">
                                ...
                                <td width="20%"  style="border: solid black 1px;"><div align="center"><strong>প্রাপকের নাম</strong></div></td>
