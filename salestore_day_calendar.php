...
///
        function makeCalendar($current_salestore_id, $current_salestore_name) {
            ...
            echo '<td><a href="salestore_day_calendar.php?action=viewCalendar&salestoreId='.$current_salestore_id.'&salesStore_name='.$current_salestore_name.'&date=' . PREV_MONTH . '" style="display:block;width:100%;height:100%;text-decoration:none;"><img src="images/left_back_2.png" style="display:block;width:100%;height:100%;text-decoration:none;"></img></a></td>';
            echo '<td colspan="5" style="text-align:center">' . CURRENT_MONTH_A . ' - ' . CURRENT_YEAR . '</td>';
            echo '<td><a href="salestore_day_calendar.php?action=viewCalendar&salestoreId='.$current_salestore_id.'&salesStore_name='.$current_salestore_name.'&date=' . NEXT_MONTH . '" style="display:block;width:100%;height:100%;text-decoration:none;"><img src="images/right_back_2.png" style="display:block;width:100%;height:100%;text-decoration:none;"></img></a></td>';
...
<div class="page_header_div">
    <div class="page_header_title">শপিং ক্যালেন্ডার</div>
</div>
