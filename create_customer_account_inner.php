...
elseif (isset($_POST['submit4'])) {
    ...
    {
        $cp_Village_idVillage = $_POST['village_id1'];
        $cp_Post_idPost = $_POST['post_id1'];
        $cp_Thana_idThana = $_POST['thana_id1'];
        $cp_house = $_POST['c_house'];
        $cp_house_no = $_POST['c_house_no'];
        $cp_road = $_POST['c_road'];
        $cp_post_code = $_POST['c_post_code']; 
    }
 else {
    ...
    //Current Address Infromation guardian
    ...
    //Permanent Address information nominee
            ...
            <form method="POST" onsubmit="" enctype="multipart/form-data" action="" id="cust_form" name="cust_form">	
                <table class="formstyle" style=" width: 90%; padding-left: 15px; padding-top: 5px;padding-bottom: 8px;" >            
                    ...
                    <tr>
                        ...
                        <td >:   <input class="box" type="file" id="scanDoc_birth_certificate" name="scanDoc_birth_certificate" style="font-size:10px;"/></td> 
                    ...
                    <tr>
                        ...
                        <td >:   <input class="box" type="file" id="scanDoc_chairman_certificate" name="scanDoc_chairman_certificate" style="font-size:10px;"/></td>
                    </tr>      
                    <tr>  
